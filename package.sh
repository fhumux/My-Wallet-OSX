...
cp $WEB_CONTENT/img/glyphicons-halflings-white.png ./img/
...
cp $RESOURCE_DIR/logo_new.png ./Resources/logo_new.png
...
cp ./bootstrap.min.css ./Resources/bootstrap.min.css
